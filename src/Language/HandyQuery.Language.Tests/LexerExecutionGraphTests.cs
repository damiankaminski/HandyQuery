...
//using HandyQuery.Language.Parsing.StateTransition;
...
//                run.Should().ThrowExactly<StateTransitionException>().Where(x => x.ErrorId == testCase.ErrorId);
//            }
//            else
//            {
...
//                        return <value>
//                    ",
//                    ErrorId = StateTransitionException.Id.InfiniteRecursion
//                };
//            }
//            
//            {
...
//            internal StateTransitionException.Id? ErrorId { get; set; }
//
